...
app.delete("/manageAllOrderDelete/:id", async (req, res) => {
    ...
    app.post('/init', async (req, res) => {
      ...
      const data = {
        ...
        tran_id: uuidv4(),
        success_url: 'https://black-electrisian.onrender.com/success',
        fail_url: 'https://black-electrisian.onrender.com/fail',
        cancel_url: 'https://black-electrisian.onrender.com/cancel',
        ipn_url: 'https://black-electrisian.onrender.com/ipn',
    ...
    app.post('/success', async (req, res) => {
      ...
      res.status(200).redirect(`https://black-electronic.vercel.app/success/${req.body.tran_id}`)
    ...
    app.post('/fail', async (req, res) => {
      ...
      res.status(400).redirect('https://black-electronic.vercel.app')
    })
    app.post('/cancel', async (req, res) => {
      // console.log(req.body);
      const order = await paymentCollection.deleteOne({ tran_id: req.body.tran_id })
      res.status(200).redirect('https://black-electronic.vercel.app/')
    })
...
app.post('/initPost', async(req, res) => {
  const data = {
    ...
    currency: 'BDT',
      ...
      success_url: 'https://black-electrisian.onrender.com/successdata',
      fail_url: 'https://black-electrisian.onrender.com/faildata',
      cancel_url: 'https://black-electrisian.onrender.com/canceldata',
      ipn_url: 'https://black-electrisian.onrender.com/ipn',
      shipping_method: 'Courier',
      product_name: req.body.product_name,
      product_category: 'Electronic',
...
app.post ('/successdata', async(req,res)=>{
  ...
  res.status(200).redirect(`https://black-electronic.vercel.app/successdata/${req.body.tran_id}`)
})
